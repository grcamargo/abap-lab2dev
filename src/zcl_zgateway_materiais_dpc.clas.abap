class ZCL_ZGATEWAY_MATERIAIS_DPC definition
  public
...
protected section.
  ...
  methods MATERIALSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZGATEWAY_MATERIAIS_MPC=>TS_MATERIAL
    raising
  ...
  methods MATERIALSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZGATEWAY_MATERIAIS_MPC=>TT_MATERIAL
...
CLASS ZCL_ZGATEWAY_MATERIAIS_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 15.01.2022 10:11:10 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZGATEWAY_MATERIAIS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA materialset_create_entity TYPE zcl_zgateway_materiais_mpc=>ts_material.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA materialset_get_entity TYPE zcl_zgateway_materiais_mpc=>ts_material.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZGATEWAY_MATERIAIS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA materialset_get_entityset TYPE zcl_zgateway_materiais_mpc=>tt_material.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA materialset_update_entity TYPE zcl_zgateway_materiais_mpc=>ts_material.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
